...
if __name__ == '__main__':
    ...
    if flagProcess == 0: ## training model from scratch
        ...
        pathCheckPOint = 'resL63/exp02-testloaders/model-l63-dlstm-1-aug10-sopt25-unet2-exp02-testloaders-Noise01-igrad02_03-dgrad25-drop20-epoch=238-val_loss=0.59.ckpt'
